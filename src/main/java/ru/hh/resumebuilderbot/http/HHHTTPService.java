...
public interface HHHTTPService {
    ...
    @GET("me")
    Call<Void> getCurrentUserInfo(@Header("Authorization") String authorization);
    ...
    Call<Void> getResumeConditions(@Header("Authorization") String authorization);
    ...
    Call<Void> resumeStatus(@Path("resume_id") String resumeId, @Header("Authorization") String authorization);
